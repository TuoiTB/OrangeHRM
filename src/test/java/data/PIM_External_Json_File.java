...
public class PIM_External_Json_File {
	public static PIM_External_Json_File getAccountData() {
		try {
			ObjectMapper mapper = new ObjectMapper();
			mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
			return mapper.readValue(new File(GlobalConstants.DATA_PATH + "Account.json"), PIM_External_Json_File.class);
