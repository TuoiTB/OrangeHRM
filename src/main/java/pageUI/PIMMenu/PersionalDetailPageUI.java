...
public class PersionalDetailPageUI {
    ...
    public static final String CHILD_DROPDOWN_BY_NAME = "XPATH=//label[text()='%s']/parent::div/following-sibling::div//div[@role='option']/span";
    ...
    public static final String EDIT_ICON_BY_FILE_NAME = "xpath=//div[text()='%s']/parent::div/following-sibling::div//button/i[@class='oxd-icon bi-pencil-fill']";
    ...
    public static final String DATA_ATTACHMENT_BY_NAME = "XPATH=//div[text()='%s']/parent::div/following-sibling::div/div[text()='%s']/parent::div/following-sibling::div/div[text()='%s']";
}
